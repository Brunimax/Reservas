...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './reserva.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESERVA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RESERVA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RESERVA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RESERVA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RESERVA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RESERVA actions', async () => {
      const arg = 42666;
