...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FOTOQUARTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FOTOQUARTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FOTOQUARTO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FOTOQUARTO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FOTOQUARTO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FOTOQUARTO actions', async () => {
      const arg = 42666;
