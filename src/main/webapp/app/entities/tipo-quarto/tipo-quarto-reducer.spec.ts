...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIPOQUARTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TIPOQUARTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TIPOQUARTO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TIPOQUARTO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TIPOQUARTO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TIPOQUARTO actions', async () => {
      const arg = 42666;
