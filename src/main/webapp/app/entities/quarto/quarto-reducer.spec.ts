...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './quarto.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUARTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_QUARTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_QUARTO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_QUARTO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_QUARTO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_QUARTO actions', async () => {
      const arg = 42666;
