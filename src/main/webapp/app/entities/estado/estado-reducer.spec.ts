...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './estado.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ESTADO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ESTADO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ESTADO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ESTADO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ESTADO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ESTADO actions', async () => {
      const arg = 42666;
